...
class mainFrame(wx.Frame):
    ...
    def __init__(self, parent):
        wx.Frame.__init__(self, parent, id=wx.ID_ANY, title=wx.EmptyString, pos=wx.DefaultPosition,
                          size=wx.Size(851, 610), style=wx.DEFAULT_FRAME_STYLE | wx.TAB_TRAVERSAL)

        self.SetSizeHints(wx.DefaultSize, wx.DefaultSize)

        bSizer1 = wx.BoxSizer(wx.VERTICAL)

        self.lblTitle = wx.StaticText(self, wx.ID_ANY, u"Penetration Test Tools", wx.DefaultPosition, wx.DefaultSize,
                                      wx.ALIGN_CENTRE)
        ...
        self.lbl1.Wrap(-1)
        self.lbl1.SetFont(
            wx.Font(18, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_BOLD, False, "Lucida Grande"))
...
class passwordCheckerFrame(wx.Frame):
    ...
    def __init__(self, parent):
        wx.Frame.__init__(self, parent, id=wx.ID_ANY, title=wx.EmptyString, pos=wx.DefaultPosition,
                          size=wx.Size(646, 419), style=wx.DEFAULT_FRAME_STYLE | wx.TAB_TRAVERSAL)

        self.SetSizeHints(wx.DefaultSize, wx.DefaultSize)

        bSizer11 = wx.BoxSizer(wx.VERTICAL)

        self.lblTitle = wx.StaticText(self, wx.ID_ANY, u"Password Checker", wx.DefaultPosition, wx.DefaultSize,
                                      wx.ALIGN_CENTRE)
        self.lblTitle.Wrap(-1)
        self.lblTitle.SetFont(
            wx.Font(36, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_BOLD, False, "Lucida Grande"))
...
class passwordGenFrame(wx.Frame):
    ...
    def __init__(self, parent):
        ...
        self.lblTitle = wx.StaticText(self, wx.ID_ANY, u"Password Generator", wx.DefaultPosition, wx.DefaultSize,
                                      wx.ALIGN_CENTRE)
        self.lblTitle.Wrap(-1)
        self.lblTitle.SetFont(
            wx.Font(36, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_BOLD, False, "Lucida Grande"))
...
class zipFrame(wx.Frame):
    ...
    def __init__(self, parent):
        ...
        self.lblTitle = wx.StaticText(self, wx.ID_ANY, u"Zip Brute Force", wx.DefaultPosition, wx.DefaultSize,
                                      wx.ALIGN_CENTRE)
        self.lblTitle.Wrap(-1)
        self.lblTitle.SetFont(
            wx.Font(36, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_BOLD, False, "Lucida Grande"))
        ...
        self.fileZip = wx.StaticText(self, wx.ID_ANY, u"Choose zip file            ", wx.DefaultPosition,
                                     wx.DefaultSize, 0)
        self.fileZip.Wrap(-1)
        wSizer2.Add(self.fileZip, 0, wx.ALIGN_CENTER | wx.ALIGN_CENTER_HORIZONTAL | wx.ALIGN_CENTER_VERTICAL | wx.ALL,
                    5)

        self.pikZiipFile = wx.FilePickerCtrl(self, wx.ID_ANY, wx.EmptyString, u"Select a file to encrypt", u"*.*",
                                             wx.DefaultPosition, wx.DefaultSize,
                                             wx.FLP_CHANGE_DIR | wx.FLP_DEFAULT_STYLE | wx.FLP_FILE_MUST_EXIST | wx.FLP_OPEN)
        ...
        wSizer21.Add(self.fileDict, 0, wx.ALIGN_CENTER | wx.ALIGN_CENTER_HORIZONTAL | wx.ALIGN_CENTER_VERTICAL | wx.ALL,
                     5)

        self.pikDictFile = wx.FilePickerCtrl(self, wx.ID_ANY, wx.EmptyString, u"Select a file to encrypt", u"*.*",
                                             wx.DefaultPosition, wx.DefaultSize,
                                             wx.FLP_CHANGE_DIR | wx.FLP_DEFAULT_STYLE | wx.FLP_FILE_MUST_EXIST | wx.FLP_OPEN)
        ...
        self.fileDi.Wrap(-1)
        wSizer211.Add(self.fileDi, 0, wx.ALIGN_CENTER | wx.ALIGN_CENTER_HORIZONTAL | wx.ALIGN_CENTER_VERTICAL | wx.ALL,
                      5)
...
class webScannerFrame(wx.Frame):
    ...
    def __init__(self, parent):
        ...
        self.Admin = wx.StaticText(self, wx.ID_ANY, u"Admin Panel Finder", wx.DefaultPosition, wx.DefaultSize,
                                   wx.ALIGN_CENTRE)
        self.Admin.Wrap(-1)
        self.Admin.SetFont(
            wx.Font(36, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_BOLD, False, "Lucida Grande"))
        ...
        self.m_staticText19.Wrap(-1)
        wSizer2.Add(self.m_staticText19, 0,
                    wx.ALIGN_CENTER | wx.ALIGN_CENTER_HORIZONTAL | wx.ALIGN_CENTER_VERTICAL | wx.ALL, 5)
...
class webScanFrame(wx.Frame):
    ...
    def __init__(self, parent):
        ...
        self.Admin = wx.StaticText(self, wx.ID_ANY, u"Web Information Scanner", wx.DefaultPosition, wx.DefaultSize,
                                   wx.ALIGN_CENTRE)
        self.Admin.Wrap(-1)
        self.Admin.SetFont(
            wx.Font(36, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_BOLD, False, "Lucida Grande"))
        ...
        self.txtResult = wx.TextCtrl(self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize,
                                     wx.TE_MULTILINE | wx.TE_READONLY | wx.TE_WORDWRAP | wx.HSCROLL | wx.VSCROLL)
...
class PSFrame(wx.Frame):
    ...
    def __init__(self, parent):
        ...
        self.Admin = wx.StaticText(self, wx.ID_ANY, u"Packet Sniffer", wx.DefaultPosition, wx.DefaultSize,
                                   wx.ALIGN_CENTRE)
        self.Admin.Wrap(-1)
        self.Admin.SetFont(
            wx.Font(36, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_BOLD, False, "Lucida Grande"))
        ...
        self.btnAttack = wx.Button(self, wx.ID_ANY, u"Attack", wx.DefaultPosition, wx.DefaultSize, 0)
...
class encryptDecryptFrame(wx.Frame):
    ...
    def __init__(self, parent):
        ...
        self.lblTitle = wx.StaticText(self, wx.ID_ANY, u"Encrypt/ Decrypt", wx.DefaultPosition, wx.DefaultSize,
                                      wx.ALIGN_CENTRE)
        self.lblTitle.Wrap(-1)
        self.lblTitle.SetFont(
            wx.Font(36, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_BOLD, False, "Lucida Grande"))
        ...
        self.m_staticText19 = wx.StaticText(self, wx.ID_ANY, u"Open file to encrypt", wx.DefaultPosition,
                                            wx.DefaultSize, 0)
        self.m_staticText19.Wrap(-1)
        wSizer2.Add(self.m_staticText19, 0,
                    wx.ALIGN_CENTER | wx.ALIGN_CENTER_HORIZONTAL | wx.ALIGN_CENTER_VERTICAL | wx.ALL, 5)

        self.pikEncryptFile = wx.FilePickerCtrl(self, wx.ID_ANY, wx.EmptyString, u"Select a file to encrypt", u"*.*",
                                                wx.DefaultPosition, wx.DefaultSize,
                                                wx.FLP_CHANGE_DIR | wx.FLP_DEFAULT_STYLE | wx.FLP_FILE_MUST_EXIST | wx.FLP_OPEN)
        ...
        self.m_staticText191 = wx.StaticText(self, wx.ID_ANY, u"Open file to decrypt", wx.DefaultPosition,
                                             wx.DefaultSize, 0)
        self.m_staticText191.Wrap(-1)
        wSizer21.Add(self.m_staticText191, 0,
                     wx.ALIGN_CENTER | wx.ALIGN_CENTER_HORIZONTAL | wx.ALIGN_CENTER_VERTICAL | wx.ALL, 5)

        self.pikDecryptFile = wx.FilePickerCtrl(self, wx.ID_ANY, wx.EmptyString, u"Select a file to encrypt", u"*.*",
                                                wx.DefaultPosition, wx.DefaultSize,
                                                wx.FLP_CHANGE_DIR | wx.FLP_DEFAULT_STYLE | wx.FLP_FILE_MUST_EXIST | wx.FLP_OPEN)
...
class dataintegrtityFrame(wx.Frame):
    ...
    def __init__(self, parent):
        ...
        self.Admin = wx.StaticText(self, wx.ID_ANY, u"Data Integrity", wx.DefaultPosition, wx.DefaultSize,
                                   wx.ALIGN_CENTRE)
        self.Admin.Wrap(-1)
        self.Admin.SetFont(
            wx.Font(36, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_BOLD, False, "Lucida Grande"))
        ...
        self.m_staticText19 = wx.StaticText(self, wx.ID_ANY, u"SHA 256", wx.DefaultPosition, wx.DefaultSize, 0)
        self.m_staticText19.Wrap(-1)
        ...
        self.fileZip.Wrap(-1)
        wSizer21.Add(self.fileZip, 0, wx.ALIGN_CENTER | wx.ALIGN_CENTER_HORIZONTAL | wx.ALIGN_CENTER_VERTICAL | wx.ALL,
                     5)

        self.pikFile = wx.FilePickerCtrl(self, wx.ID_ANY, wx.EmptyString, u"Select a file to encrypt", u"*.*",
                                         wx.DefaultPosition, wx.DefaultSize,
                                         wx.FLP_CHANGE_DIR | wx.FLP_DEFAULT_STYLE | wx.FLP_FILE_MUST_EXIST | wx.FLP_OPEN)
...
class arpSpoofingFrame(wx.Frame):
    ...
    def __init__(self, parent):
        ...
        self.lblTitle = wx.StaticText(self, wx.ID_ANY, u"ARP spoofing", wx.DefaultPosition, wx.DefaultSize,
                                      wx.ALIGN_CENTRE)
        self.lblTitle.Wrap(-1)
        self.lblTitle.SetFont(
            wx.Font(36, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_BOLD, False, "Lucida Grande"))
        ...
        self.m_staticText19 = wx.StaticText(self, wx.ID_ANY, u"Victom IP Address     ", wx.DefaultPosition,
                                            wx.DefaultSize, 0)
        self.m_staticText19.Wrap(-1)
        wSizer2.Add(self.m_staticText19, 0,
                    wx.ALIGN_CENTER | wx.ALIGN_CENTER_HORIZONTAL | wx.ALIGN_CENTER_VERTICAL | wx.ALL, 5)
        ...
        self.m_staticText191 = wx.StaticText(self, wx.ID_ANY, u"Victom MAC Address", wx.DefaultPosition, wx.DefaultSize,
                                             0)
        self.m_staticText191.Wrap(-1)
        wSizer21.Add(self.m_staticText191, 0,
                     wx.ALIGN_CENTER | wx.ALIGN_CENTER_HORIZONTAL | wx.ALIGN_CENTER_VERTICAL | wx.ALL, 5)
        ...
        self.m_staticText1911 = wx.StaticText(self, wx.ID_ANY, u"Router IP Address     ", wx.DefaultPosition,
                                              wx.DefaultSize, 0)
        self.m_staticText1911.Wrap(-1)
        wSizer211.Add(self.m_staticText1911, 0,
                      wx.ALIGN_CENTER | wx.ALIGN_CENTER_HORIZONTAL | wx.ALIGN_CENTER_VERTICAL | wx.ALL, 5)
        ...
        bSizer32.Add(self.btnActionAttack, 0,
                     wx.ALIGN_CENTER | wx.ALIGN_CENTER_HORIZONTAL | wx.ALL | wx.ALIGN_CENTER_VERTICAL, 5)
...
class webNetworkScanFrame(wx.Frame):
    ...
    def __init__(self, parent):
        ...
        self.Admin = wx.StaticText(self, wx.ID_ANY, u"Network Scanner", wx.DefaultPosition, wx.DefaultSize,
                                   wx.ALIGN_CENTRE)
        self.Admin.Wrap(-1)
        self.Admin.SetFont(
            wx.Font(36, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_BOLD, False, "Lucida Grande"))
